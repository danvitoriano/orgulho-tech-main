        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="p-7 md:p-10 lg:p-12">
            ...
            <p className="mt-5 text-base md:text-lg leading-relaxed max-w-2xl">
              ...
              Devs 40+ e Elas Programam em São Paulo, com participação presencial e online.
              Dia 19/3 (quinta), a partir das 19h. O local em São Paulo será divulgado em breve.
            </p>
            <div className="mt-6 flex flex-wrap gap-2">
              ...
              <span className="badge badge-lg border-0 bg-[#0f766e] text-white whitespace-normal h-auto py-2 text-center max-w-full">
                Local em São Paulo será divulgado em breve + transmissão online
              </span>
            </div>
            <div className="mt-8">
